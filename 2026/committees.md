...
<div class="row">
  <div class="col-xs-12 col-sm-6 col-lg-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">        
        <h4><a href="https://www.york.ac.uk/arts-creative-technologies/people/dar'ya-guarnera/" target="_blank">Dar'ya Guarnera</a><br><small>University of York, UK</small></h4>
      </div>
    </div>
  </div>
  ...
  <div class="col-xs-12 col-sm-6 col-lg-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <h4><a href="https://cj-oh.github.io" target="_blank">Changjae Oh</a><br><small>Queen Mary University of London, UK</small></h4>
      </div>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-xs-12 col-sm-6 col-lg-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <h4><a href="https://www.lumirithmic.com/" target="_blank">Arvin Lin</a><br><small>Lumirithmic Ltd, UK</small></h4>
      </div>
    </div>
  </div>
...
<div class="col-xs-12 col-sm-6 col-lg-4">
  ...
  <div class="col-xs-12 col-sm-6 col-lg-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <h4><a href="https://w-rowan.github.io/" target="_blank">Will Rowan</a><br><small>University of York, UK</small></h4>
      </div>
    </div>
  </div>
  ...
  <div class="col-xs-12 col-sm-6 col-lg-4">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">Special Session Chair</h4>
      </div>
      <div class="panel-body">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-4 col-lg-4">
            <h4><a href="https://richardt.name/" target="_blank">Christian Richardt</a><br><small>Meta Reality Labs, Switzerland</small></h4>
          </div>
        </div>
      </div>
    </div>
