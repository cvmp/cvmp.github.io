...
---
Please check our website https://cvmp-conference.org/ and follow @CVMP on X for the latest updates. Proceedings of the Full Papers will appear in the ACM Digital Library, subject to ACM approval of this year's conference. 
...
| __Full Papers deadline:__ | TBD |
| - Review deadline: | TBD |
| - Author notification: | TBD |
| - Camera-ready submission deadline: | TBD |
| __Industry Talks deadline:__ | TBD |
| - Author notification: | TBD |
| __Short Papers deadline:__ | TBD |
| - Author notification: | TBD |
| __Demos deadline:__ | TBD |
| - Author notification: | TBD |
...
- Neural rendering techniques (NeRF, 3D Gaussian Splatting, etc.)
...
Please ensure that you and your co-authors [obtain an ORCID ID](https://orcid.org/register), so you can complete the publishing process for your accepted paper.  ACM has been involved in ORCID from the start and we have recently made a [commitment to collect ORCID IDs from all of our published authors](https://authors.acm.org/author-resources/orcid-faqs).  The collection process has started and will roll out as a requirement throughout 2025.  We are committed to improve author discoverability, ensure proper attribution and contribute to ongoing community efforts around name normalization; your ORCID ID will help in these efforts.
